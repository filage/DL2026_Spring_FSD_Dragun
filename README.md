...
### 🛣️ PathToPlace (маршрут до места)

![PathToPlace](docs/images/PathToPlace.png)

## 🤖 Использованные AI-инструменты

- **Cascade (IDE ассистент)** — помогал с отладкой, рефакторингом и быстрыми правками по фронту/бэку.
